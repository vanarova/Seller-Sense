Seller-Sense is a tool to consolidate inventory from various sources like: Amazon, Prestashop, Flipkart, Snapdeal.

Seller-sense can take prestashop as primary inventory source, It can automatically import data using prestashop api.
If Prestashop is not available, inventory can be uploaded using simple csv file.
