...
namespace Identity
{
    public class RegistrationHelper
    {
        ...
        private static string GetRegistrationDetailsAsJSON(RegistrationHelper registrationObj)
        {
        ...
        public static void Register(RegistrationHelper registrationObj)
        {
            ...
            FrBase.Messenger fbHelper = new FrBase.Messenger();
            //fbHelper.GetFirebaseDatabaseRef();
            string UID = GetIds();
            fbHelper.WriteData(UID, registrationDetails);
