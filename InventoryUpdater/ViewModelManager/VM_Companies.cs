    ...
    internal class VM_Companies
    {
        ...
        private void LoadLastSavedCompanies()
        {
            ...
            if (DoesCompanyExist(Constants.Company1Name, Constants.Company1Code))
                _companies.Add(new VM_Company(ProjIO.GetUserSetting(Constants.Company1Name), ProjIO.GetUserSetting(Constants.Company1Code)));

            if (DoesCompanyExist(Constants.Company2Name, Constants.Company2Code))
                _companies.Add(new VM_Company(ProjIO.GetUserSetting(Constants.Company2Name), ProjIO.GetUserSetting(Constants.Company2Code)));

            if (DoesCompanyExist(Constants.Company3Name, Constants.Company3Code))
                _companies.Add(new VM_Company(ProjIO.GetUserSetting(Constants.Company3Name), ProjIO.GetUserSetting(Constants.Company3Code)));

            if (DoesCompanyExist(Constants.Company4Name, Constants.Company4Code))
                _companies.Add(new VM_Company(ProjIO.GetUserSetting(Constants.Company4Name), ProjIO.GetUserSetting(Constants.Company4Code)));

            if (DoesCompanyExist(Constants.Company5Name, Constants.Company5Code))
                _companies.Add(new VM_Company(ProjIO.GetUserSetting(Constants.Company5Name), ProjIO.GetUserSetting(Constants.Company5Code)));
        }
