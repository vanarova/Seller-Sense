...
namespace SellerSense.Model
{
    ...
    /// </summary>
    public abstract class M_BaseCode
    {
        ...
        public M_BaseCode(string img, string code, string price, string title)
        {
            Image = img;
            BaseCodeValue = code;
            Price = price;
    ...
    /// </summary>
    public class BaseCodeV1 : M_BaseCode, IBaseCodeV1
    {
    ...
    /// </summary>
    public class BaseCodeV2 : M_BaseCode, IBaseCodeV2
    {
